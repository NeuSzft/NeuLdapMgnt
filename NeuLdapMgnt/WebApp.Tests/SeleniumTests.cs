...
namespace NeuLdapMgnt.WebApp.Tests
{
    ...
    public class SeleniumTests
    {
        ...
        private static string SutMngt = string.Empty;
        ...
        {
            SutMngt = !EnvironmentMode.Equals("Docker") ? SutMngtLocal : SutMngtDocker;
        ...
        public void NavbarLinksAreWorking()
        {
            Login();
            ExpandNavbar();
            var navLinks = _webDriver.FindElements(By.ClassName("nav-link")).ToList();
