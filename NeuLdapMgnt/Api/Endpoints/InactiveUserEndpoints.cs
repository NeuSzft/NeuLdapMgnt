...
public static class InactiveUserEndpoints {
    public static void MapInactiveUserEndpoints(this WebApplication app) {
        app.MapGet("/inactives", (LdapService ldap, HttpRequest request) => {
        ...
        app.MapPost("/inactives/{id}", (LdapService ldap, HttpRequest request, long id) => {
        ...
        app.MapDelete("/inactives/{id}", (LdapService ldap, HttpRequest request, long id) => {
