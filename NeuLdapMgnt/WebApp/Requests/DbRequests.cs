...
namespace NeuLdapMgnt.WebApp.Requests
{
	public static class DbRequests
	{
		...
		public static async Task<RequestResult> AddClassesAsync(this ApiRequests apiRequests, IEnumerable<string> classes)
			=> await apiRequests.SendRequestAsync(HttpMethod.Put, "/api/classes", classes);
